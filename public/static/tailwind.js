        ...
        if (p === ye)
            ...
            for (let h = c + 1; h < t.length; h++)
                ...
                d === ye)
                    ...
                    if (d === oe)
                        throw new Error(`Unterminated string: ${t.slice(m, h) + String.fromCharCode(p)}`)
                }
            l += t.slice(m, c + 1)
        } else {
            ...
            if (p === oe) {
                ...
                for (let b = c + 2; b < t.length; b++)
                    ...
                    d === ye)
                        ...
                        (d === Ct || d === ro || d === Ze) && m.length > 0 && t[b] === m[m.length - 1] && (m = m.slice(0, -1));
                let v = Xe(l, y);
                n ? n.nodes.push(v) : r.push(v),
                l = ""
            } else if (p === Re && l.charCodeAt(0) === Qe)
                s = ke(l),
                n ? n.nodes.push(s) : r.push(s),
                l = "",
                s = null;
            else if (p === Re && f[f.length - 1] !== ")") {
                let m = Xe(l);
                n ? n.nodes.push(m) : r.push(m),
                l = ""
                ...
                if (l.length === 0 && (p === ve || p === oe || p === Oe))
                    continue;
                l += String.fromCharCode(p)
            }
        }
    }
    if (l.charCodeAt(0) === Qe && r.push(ke(l)),
    f.length > 0 && n) {
        if (n.kind === "rule")
...
function _(t, r, o=[], e={}) {
    for (let n = 0; n < t.length; n++) {
        ...
        let f = r(s, {
            ...
            path: o,
            replaceWith(d) {
                Array.isArray(d) ? d.length === 0 ? t.splice(n, 1) : d.length === 1 ? t[n] = d[0] : t.splice(n, 1, ...d) : t[n] = d,
                n--
            }
        }) ?? 0;
        if (o.pop(),
...
function ze(t, r, o=[], e={}) {
    for (let n = 0; n < t.length; n++) {
        ...
        r(s, {
            ...
            path: o,
            replaceWith(f) {
                Array.isArray(f) ? f.length === 0 ? t.splice(n, 1) : f.length === 1 ? t[n] = f[0] : t.splice(n, 1, ...f) : t[n] = f,
                n += f.length - 1
            }
        }),
        o.pop()
...
function ie(t) {
    ...
    function e(s, l, f=0) {
        if (s.kind === "declaration") {
            if (s.property === "--tw-sort" || s.value === void 0 || s.value === null)
                return;
            l.push(s)
        } else if (s.kind === "rule")
            if (s.selector === "&")
            ...
            if (s.context.reference)
                return;
            for (let d of s.nodes)
                e(d, l, f)
        } else
            s.kind === "comment" && l.push(s)
    }
    let n = [];
    for (let s of t)
        e(s, n, 0);
...
`
            ...
            s += `${l}/*${e.value}*/
`;
        else if (e.kind === "context" || e.kind === "at-root")
            return "";
        return s
    }
    let o = "";
    ...
    for (let e = 0; e < t.length; e++) {
        let n = t[e]
          , s = r(n, {
            parent: o,
            replaceWith(l) {
                Array.isArray(l) ? l.length === 0 ? t.splice(e, 1) : l.length === 1 ? t[e] = l[0] : t.splice(e, 1, ...l) : t[e] = l,
                e--
            }
        }) ?? 0;
        if (s === 2)
            return 2;
        if (s !== 1 && n.kind === "function" && fe(n.nodes, r, n) === 2)
            return 2
    }
}
function H(t) {
...
`);
        ...
        case zt:
            {
                ...
                let d = l
                  , c = l + 1;
                for (; c < t.length && (s = t.charCodeAt(c),
                !(s !== Nt && s !== St && s !== Tt && s !== Vt && s !== Et && s !== Rt && s !== Ot && s !== Kt && s !== zt)); c++)
                    ;
                l = c - 1;
    ...
    return n.length > 0 && r.push(rt(n)),
    r
}
var ot = ["calc", "min", "max", "clamp", "mod", "rem", "sin", "cos", "tan", "asin", "acos", "atan", "atan2", "pow", "sqrt", "hypot", "log", "exp", "round"]
  , _e = ["anchor-size"]
...
function _t(t) {
    if (!ot.some(n => t.includes(n)))
        return t;
    let r = !1;
    _e.some(n => t.includes(n)) && (Pt.lastIndex = 0,
    t = t.replace(Pt, (n, s) => (r = !0,
    `$${_e.indexOf(s)}$(`)));
    let o = ""
      , e = [];
    for (let n = 0; n < t.length; n++) {
        ...
        case "function":
            {
                ...
                if (r.value === "var" || r.value.endsWith("_var") || r.value === "theme" || r.value.endsWith("_theme")) {
                    ...
                    for (let o = 0; o < r.nodes.length; o++)
                        o == 0 && r.nodes[o].kind === "word" || nt([r.nodes[o]]);
                    break
                }
                r.value = xe(r.value),
                nt(r.nodes);
...
function *Ft(t, r) {
    ...
    let s = !1;
    e[e.length - 1] === "!" ? (s = !0,
    e = e.slice(0, -1)) : e[0] === "!" && (s = !0,
    e = e.slice(1)),
    r.utilities.has(e, "static") && !e.includes("[") && (yield{
        kind: "static",
        root: e,
        variants: n,
        important: s,
    ...
    if (l[l.length - 1] === "]") {
        ...
        if (m === -1)
            return;
        let h = l.slice(0, m);
        if (!r.utilities.has(h, "functional"))
            return;
        let y = l.slice(m + 1);
        p = [[h, y]]
        ...
        p = Lt(l, m => r.utilities.has(m, "functional"));
    for (let[m,h] of p) {
        let y = {
            kind: "functional",
            root: m,
            ...
            case "compound":
                {
                    ...
                    if (d === null || !r.variants.compoundsWith(l, d))
                        return null;
...
var ko = /^(?:element|image|cross-fade|image-set)\(/
...
var Vo = new RegExp(`^${X.source}%$`);
function lt(t) {
    return Vo.test(t) || we(t)
}
var Eo = new RegExp(`^${X.source}s*/s*${X.source}$`);
function Ro(t) {
    return Eo.test(t) || we(t)
}
var Oo = ["cm", "mm", "Q", "in", "pc", "pt", "px", "em", "ex", "ch", "rem", "lh", "rlh", "vw", "vh", "vmin", "vmax", "vb", "vi", "svw", "svh", "lvw", "lvh", "dvw", "dvh", "cqw", "cqh", "cqi", "cqb", "cqmin", "cqmax"]
...
var _o = ["deg", "rad", "grad", "turn"]
  , Do = new RegExp(`^${X.source}(${_o.join("|")})$`);
function Uo(t) {
    return Do.test(t)
}
var jo = new RegExp(`^${X.source} +${X.source} +${X.source}$`);
function Fo(t) {
    return jo.test(t)
}
function N(t) {
...
var Io = new Set(["inset", "inherit", "initial", "revert", "unset"])
  , qt = /^-?(\d+|\.\d+)(.*?)$/g;
function ae(t, r) {
    return K(t, ",").map(e => {
        e = e.trim();
        let n = K(e, " ").filter(c => c.trim() !== "")
          ...
          , f = null;
        for (let c of n)
            Io.has(c) || (qt.test(c) ? (l === null ? l = c : f === null && (f = c),
            qt.lastIndex = 0) : s === null && (s = c));
        if (l === null || f === null)
            return e;
...
;
function $(t, r, o) {
    return P("@property", t, [a("syntax", o ? `"${o}"` : '"*"'), a("inherits", "false"), ...r ? [a("initial-value", r)] : []])
}
function J(t, r) {
    if (r === null)
        return t;
    let o = Number(r);
    return Number.isNaN(o) || (r = `${o * 100}%`),
...
function Gt(t) {
    ...
    function o(i, u) {
        function *g(w) {
            for (let k of t.keysInNamespaces(w))
                yield k.replaceAll("_", ".")
        }
        r.suggest(i, () => {
            let w = [];
            for (let k of u()) {
                ...
                k.hasDefaultValue && T.unshift(null),
                w.push({
            ...
            return k => {
                ...
                if (k.value)
                    if (k.value.kind === "arbitrary") {
                        ...
                        if (T = t.resolve(k.value.fraction ?? k.value.value, u.themeKeys ?? []),
                        ...
                        if (T === null && w && u.handleNegativeBareValue) {
                            if (T = u.handleNegativeBareValue(k.value),
                            !T?.includes("/") && k.modifier)
                                return;
                            if (T !== null)
                                return u.handle(T)
                        }
                        if (T === null && u.handleBareValue && (T = u.handleBareValue(k.value),
                        !T?.includes("/") && k.modifier))
                            return
                    }
                else {
                ...
                if (T !== null)
                    return u.handle(w ? `calc(${T} * -1)` : T)
            }
        }
        u.supportsNegative && r.functional(`-${i}`, g({
            negative: !0
        })),
        r.functional(i, g({
            negative: !1
    ...
    function s(i, u) {
        r.functional(i, g => {
            if (!g.value)
                return;
            let w = null;
            if (g.value.kind === "arbitrary" ? (w = g.value.value,
            w = W(w, g.modifier, t)) : w = G(g, t, u.themeKeys),
            w !== null)
                return u.handle(w)
        }
        ),
    ...
    e("sr-only", [["position", "absolute"], ["width", "1px"], ["height", "1px"], ["padding", "0"], ["margin", "-1px"], ["overflow", "hidden"], ["clip", "rect(0, 0, 0, 0)"], ["white-space", "nowrap"], ["border-width", "0"]]),
    e("not-sr-only", [["position", "static"], ["width", "auto"], ["height", "auto"], ["padding", "0"], ["margin", "0"], ["overflow", "visible"], ["clip", "auto"], ["white-space", "normal"]]),
    ...
    for (let[i,u] of [["inset", "inset"], ["inset-x", "inset-inline"], ["inset-y", "inset-block"], ["start", "inset-inline-start"], ["end", "inset-inline-end"], ["top", "top"], ["right", "right"], ["bottom", "bottom"], ["left", "left"]])
        e(`${i}-auto`, [[u, "auto"]]),
        e(`${i}-full`, [[u, "100%"]]),
        e(`-${i}-full`, [[u, "-100%"]]),
        l(i, ["--inset", "--spacing"], g => [a(u, g)], {
            supportsNegative: !0,
            supportsFractions: !0
        });
    ...
    for (let[i,u] of [["m", "margin"], ["mx", "margin-inline"], ["my", "margin-block"], ["ms", "margin-inline-start"], ["me", "margin-inline-end"], ["mt", "margin-top"], ["mr", "margin-right"], ["mb", "margin-bottom"], ["ml", "margin-left"]])
        e(`${i}-auto`, [[u, "auto"]]),
        l(i, ["--margin", "--spacing"], g => [a(u, g)], {
            supportsNegative: !0
        });
    e("box-border", [["box-sizing", "border-box"]]),
    e("box-content", [["box-sizing", "content-box"]]),
    e("line-clamp-none", [["overflow", "visible"], ["display", "block"], ["-webkit-box-orient", "horizontal"], ["-webkit-line-clamp", "unset"]]),
    n("line-clamp", {
    ...
    for (let[i,u] of [["auto", "auto"], ["full", "100%"], ["svw", "100svw"], ["lvw", "100lvw"], ["dvw", "100dvw"], ["svh", "100svh"], ["lvh", "100lvh"], ["dvh", "100dvh"], ["min", "min-content"], ["max", "max-content"], ["fit", "fit-content"]])
        e(`size-${i}`, [["--tw-sort", "size"], ["width", u], ["height", u]]),
        e(`w-${i}`, [["width", u]]),
    ...
    for (let[i,u,g] of [["w", ["--width", "--spacing", "--container"], "width"], ["min-w", ["--min-width", "--spacing", "--container"], "min-width"], ["max-w", ["--max-width", "--spacing", "--container"], "max-width"], ["h", ["--height", "--spacing"], "height"], ["min-h", ["--min-height", "--height", "--spacing"], "min-height"], ["max-h", ["--max-height", "--height", "--spacing"], "max-height"]])
        l(i, u, w => [a(g, w)], {
            supportsFractions: !0
        });
    r.static("container", () => {
        ...
        for (let g of i)
            u.push(P("@media", `(width >= ${g})`, [a("max-width", g)]));
        return u
    }
    ),
    ...
    l("border-spacing", ["--border-spacing", "--spacing"], i => [f(), a("--tw-border-spacing-x", i), a("--tw-border-spacing-y", i), a("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")]),
    l("border-spacing-x", ["--border-spacing", "--spacing"], i => [f(), a("--tw-border-spacing-x", i), a("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")]),
    l("border-spacing-y", ["--border-spacing", "--spacing"], i => [f(), a("--tw-border-spacing-y", i), a("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")]),
    ...
    e("-translate-full", [d, ["--tw-translate-x", "-100%"], ["--tw-translate-y", "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]),
    e("translate-full", [d, ["--tw-translate-x", "100%"], ["--tw-translate-y", "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]),
    l("translate", ["--translate", "--spacing"], i => [d(), a("--tw-translate-x", i), a("--tw-translate-y", i), a("translate", "var(--tw-translate-x) var(--tw-translate-y)")], {
        supportsNegative: !0,
        supportsFractions: !0
    });
    for (let i of ["x", "y"])
        e(`-translate-${i}-full`, [d, [`--tw-translate-${i}`, "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]),
        e(`translate-${i}-full`, [d, [`--tw-translate-${i}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]),
        l(`translate-${i}`, ["--translate", "--spacing"], u => [d(), a(`--tw-translate-${i}`, u), a("translate", "var(--tw-translate-x) var(--tw-translate-y)")], {
            supportsNegative: !0,
            supportsFractions: !0
        });
    l("translate-z", ["--translate", "--spacing"], i => [d(), a("--tw-translate-z", i), a("translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)")], {
        supportsNegative: !0
    }),
    e("-translate-z-px", [d, ["--tw-translate-z", "-1px"], ["translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"]]),
    e("translate-z-px", [d, ["--tw-translate-z", "1px"], ["translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"]]),
    ...
    function p({negative: i}) {
        return u => {
            ...
            [a("scale", g)]) : (g = t.resolve(u.value.value, ["--scale"]),
            !g && N(u.value.value) && (g = `${u.value.value}%`),
            g ? (g = i ? `calc(${g} * -1)` : g,
            [c(), a("--tw-scale-x", g), a("--tw-scale-y", g), a("--tw-scale-z", g), a("scale", "var(--tw-scale-x) var(--tw-scale-y)")]) : void 0)
        }
    }
    ...
    for (let i of ["x", "y", "z"])
        n(`scale-${i}`, {
            ...
            handle: u => [c(), a(`--tw-scale-${i}`, u), a("scale", `var(--tw-scale-x) var(--tw-scale-y)${i === "z" ? " var(--tw-scale-z)" : ""}`)]
        }),
        o(`scale-${i}`, () => [{
            supportsNegative: !0,
            values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"],
    ...
    function m({negative: i}) {
        return u => {
            ...
            if (u.value.kind === "arbitrary") {
                ...
                if (w === "vector")
                    return [a("rotate", `${g} var(--tw-rotate)`)];
                if (w !== "angle")
                    return [a("rotate", g)]
            } else if (g = t.resolve(u.value.value, ["--rotate"]),
            !g && N(u.value.value) && (g = `${u.value.value}deg`),
            !g)
                return;
    ...
    }]);
    {
        let i = ["var(--tw-rotate-x)", "var(--tw-rotate-y)", "var(--tw-rotate-z)", "var(--tw-skew-x)", "var(--tw-skew-y)"].join(" ")
          , u = () => D([$("--tw-rotate-x", "rotateX(0)"), $("--tw-rotate-y", "rotateY(0)"), $("--tw-rotate-z", "rotateZ(0)"), $("--tw-skew-x", "skewX(0)"), $("--tw-skew-y", "skewY(0)")]);
        for (let g of ["x", "y", "z"])
            n(`rotate-${g}`, {
                supportsNegative: !0,
                themeKeys: ["--rotate"],
        ...
        r.functional("transform", g => {
            if (g.modifier)
                return;
            let w = null;
            if (g.value ? g.value.kind === "arbitrary" && (w = g.value.value) : w = i,
            w !== null)
    ...
    for (let i of ["x", "left", "right"])
        e(`touch-pan-${i}`, [h, ["--tw-pan-x", `pan-${i}`], ["touch-action", "var(--tw-pan-x,) var(--tw-pan-y,) var(--tw-pinch-zoom,)"]]);
    for (let i of ["y", "up", "down"])
        e(`touch-pan-${i}`, [h, ["--tw-pan-y", `pan-${i}`], ["touch-action", "var(--tw-pan-x,) var(--tw-pan-y,) var(--tw-pinch-zoom,)"]]);
    e("touch-pinch-zoom", [h, ["--tw-pinch-zoom", "pinch-zoom"], ["touch-action", "var(--tw-pan-x,) var(--tw-pan-y,) var(--tw-pinch-zoom,)"]]);
    for (let i of ["none", "text", "all", "auto"])
        e(`select-${i}`, [["-webkit-user-select", i], ["user-select", i]]);
    ...
    for (let i of ["x", "y", "both"])
        e(`snap-${i}`, [y, ["scroll-snap-type", `${i} var(--tw-scroll-snap-strictness)`]]);
    ...
    for (let[i,u] of [["scroll-m", "scroll-margin"], ["scroll-mx", "scroll-margin-inline"], ["scroll-my", "scroll-margin-block"], ["scroll-ms", "scroll-margin-inline-start"], ["scroll-me", "scroll-margin-inline-end"], ["scroll-mt", "scroll-margin-top"], ["scroll-mr", "scroll-margin-right"], ["scroll-mb", "scroll-margin-bottom"], ["scroll-ml", "scroll-margin-left"]])
        l(i, ["--scroll-margin", "--spacing"], g => [a(u, g)], {
            supportsNegative: !0
        });
    for (let[i,u] of [["scroll-p", "scroll-padding"], ["scroll-px", "scroll-padding-inline"], ["scroll-py", "scroll-padding-block"], ["scroll-ps", "scroll-padding-inline-start"], ["scroll-pe", "scroll-padding-inline-end"], ["scroll-pt", "scroll-padding-top"], ["scroll-pr", "scroll-padding-right"], ["scroll-pb", "scroll-padding-bottom"], ["scroll-pl", "scroll-padding-left"]])
    ...
    l("space-x", ["--space", "--spacing"], i => [D([$("--tw-space-x-reverse", "0")]), U(":where(& > :not(:last-child))", [a("--tw-sort", "row-gap"), a("--tw-space-x-reverse", "0"), a("margin-inline-start", `calc(${i} * var(--tw-space-x-reverse))`), a("margin-inline-end", `calc(${i} * calc(1 - var(--tw-space-x-reverse)))`)])], {
        supportsNegative: !0
    }),
    l("space-y", ["--space", "--spacing"], i => [D([$("--tw-space-y-reverse", "0")]), U(":where(& > :not(:last-child))", [a("--tw-sort", "column-gap"), a("--tw-space-y-reverse", "0"), a("margin-block-start", `calc(${i} * var(--tw-space-y-reverse))`), a("margin-block-end", `calc(${i} * calc(1 - var(--tw-space-y-reverse)))`)])], {
        supportsNegative: !0
    }),
    e("space-x-reverse", [ () => D([$("--tw-space-x-reverse", "0")]), () => U(":where(& > :not(:last-child))", [a("--tw-sort", "row-gap"), a("--tw-space-x-reverse", "1")])]),
    e("space-y-reverse", [ () => D([$("--tw-space-y-reverse", "0")]), () => U(":where(& > :not(:last-child))", [a("--tw-sort", "column-gap"), a("--tw-space-y-reverse", "1")])]),
    ...
    e("hyphens-none", [["-webkit-hyphens", "none"], ["hyphens", "none"]]),
    e("hyphens-manual", [["-webkit-hyphens", "manual"], ["hyphens", "manual"]]),
    e("hyphens-auto", [["-webkit-hyphens", "auto"], ["hyphens", "auto"]]),
    ...
    for (let[i,u] of [["rounded", ["border-radius"]], ["rounded-s", ["border-start-start-radius", "border-end-start-radius"]], ["rounded-e", ["border-start-end-radius", "border-end-end-radius"]], ["rounded-t", ["border-top-left-radius", "border-top-right-radius"]], ["rounded-r", ["border-top-right-radius", "border-bottom-right-radius"]], ["rounded-b", ["border-bottom-right-radius", "border-bottom-left-radius"]], ["rounded-l", ["border-top-left-radius", "border-bottom-left-radius"]], ["rounded-ss", ["border-start-start-radius"]], ["rounded-se", ["border-start-end-radius"]], ["rounded-ee", ["border-end-end-radius"]], ["rounded-es", ["border-end-start-radius"]], ["rounded-tl", ["border-top-left-radius"]], ["rounded-tr", ["border-top-right-radius"]], ["rounded-br", ["border-bottom-right-radius"]], ["rounded-bl", ["border-bottom-left-radius"]]])
        e(`${i}-none`, u.map(g => [g, "0"])),
        e(`${i}-full`, u.map(g => [g, "calc(infinity * 1px)"])),
        n(i, {
            themeKeys: ["--radius"],
            handle: g => u.map(w => a(w, g))
        });
    e("border-solid", [["--tw-border-style", "solid"], ["border-style", "solid"]]),
    e("border-dashed", [["--tw-border-style", "dashed"], ["border-style", "dashed"]]),
    e("border-dotted", [["--tw-border-style", "dotted"], ["border-style", "dotted"]]),
    e("border-double", [["--tw-border-style", "double"], ["border-style", "double"]]),
    e("border-hidden", [["--tw-border-style", "hidden"], ["border-style", "hidden"]]),
    e("border-none", [["--tw-border-style", "none"], ["border-style", "none"]]);
    {
        let u = function(g, w) {
            r.functional(g, k => {
                if (!k.value) {
                ...
                if (k.value.kind === "arbitrary") {
                    ...
                    default:
                        return T = W(T, k.modifier, t),
                        T === null ? void 0 : w.color(T)
                    }
                }
                {
        ...
        n("divide-x", {
            ...
            handle: g => [D([$("--tw-divide-x-reverse", "0")]), U(":where(& > :not(:last-child))", [a("--tw-sort", "divide-x-width"), i(), a("--tw-divide-x-reverse", "0"), a("border-inline-style", "var(--tw-border-style)"), a("border-inline-start-width", `calc(${g} * var(--tw-divide-x-reverse))`), a("border-inline-end-width", `calc(${g} * calc(1 - var(--tw-divide-x-reverse)))`)])]
        }),
        n("divide-y", {
            defaultValue: t.get(["--default-border-width"]) ?? "1px",
            themeKeys: ["--divide-width", "--border-width"],
            handleBareValue: ({value: g}) => N(g) ? `${g}px` : null,
            handle: g => [D([$("--tw-divide-y-reverse", "0")]), U(":where(& > :not(:last-child))", [a("--tw-sort", "divide-y-width"), i(), a("--tw-divide-y-reverse", "0"), a("border-bottom-style", "var(--tw-border-style)"), a("border-top-style", "var(--tw-border-style)"), a("border-top-width", `calc(${g} * var(--tw-divide-y-reverse))`), a("border-bottom-width", `calc(${g} * calc(1 - var(--tw-divide-y-reverse)))`)])]
        }),
        o("divide-x", () => [{
            values: ["0", "2", "4", "8"],
        ...
        e("divide-x-reverse", [ () => D([$("--tw-divide-x-reverse", "0")]), () => U(":where(& > :not(:last-child))", [a("--tw-divide-x-reverse", "1")])]),
        e("divide-y-reverse", [ () => D([$("--tw-divide-y-reverse", "0")]), () => U(":where(& > :not(:last-child))", [a("--tw-divide-y-reverse", "1")])]);
        for (let g of ["solid", "dashed", "dotted", "double", "none"])
            e(`divide-${g}`, [ () => U(":where(& > :not(:last-child))", [a("--tw-sort", "divide-style"), a("--tw-border-style", g), a("border-style", g)])])
    }
    ...
    e("bg-none", [["background-image", "none"]]);
    {
          ...
          , w = function({negative: T}) {
            return O => {
                ...
                if (O.value.kind === "arbitrary") {
                    ...
                    case "angle":
                        return j = T ? `calc(${j} * -1)` : `${j}`,
                        [a("--tw-gradient-position", `${j},`), a("background-image", `linear-gradient(var(--tw-gradient-stops,${j}))`)];
                    default:
                        return T ? void 0 : [a("--tw-gradient-position", `${j},`), a("background-image", `linear-gradient(var(--tw-gradient-stops,${j}))`)]
                    }
                }
                let C = O.value.value;
                if (!T && u.has(C))
            ...
            return O => {
                if (O.value?.kind === "arbitrary") {
                    if (O.modifier)
                        return;
                    let j = O.value.value;
                    return [a("--tw-gradient-position", `${j},`), a("background-image", `conic-gradient(var(--tw-gradient-stops,${j}))`)]
                }
                let C = g(O.modifier);
                if (!O.value)
                    return [a("--tw-gradient-position", `${C},`), a("background-image", "conic-gradient(var(--tw-gradient-stops))")];
                let A = O.value.value;
                if (N(A))
                    return A = T ? `calc(${A} * -1)` : `${A}deg`,
                    [a("--tw-gradient-position", `from ${A} ${C},`), a("background-image", "conic-gradient(var(--tw-gradient-stops))")]
            }
        };
        var S = g
          , V = w
        ...
        let i = ["oklab", "oklch", "srgb", "hsl", "longer", "shorter", "increasing", "decreasing"]
          , u = new Map([["to-t", "to top"], ["to-tr", "to top right"], ["to-r", "to right"], ["to-br", "to bottom right"], ["to-b", "to bottom"], ["to-bl", "to bottom left"], ["to-l", "to left"], ["to-tl", "to top left"]]);
        ...
        r.functional("bg-radial", T => {
            if (!T.value) {
                let O = g(T.modifier);
                return [a("--tw-gradient-position", `${O},`), a("background-image", "radial-gradient(var(--tw-gradient-stops))")]
            }
            if (T.value.kind === "arbitrary") {
                if (T.modifier)
                    return;
                let O = T.value.value;
                return [a("--tw-gradient-position", `${O},`), a("background-image", `radial-gradient(var(--tw-gradient-stops,${O}))`)]
            }
        }
        ),
        o("bg-radial", () => [{
    ...
    let v = () => D([$("--tw-gradient-position"), $("--tw-gradient-from", "#0000", "<color>"), $("--tw-gradient-via", "#0000", "<color>"), $("--tw-gradient-to", "#0000", "<color>"), $("--tw-gradient-stops"), $("--tw-gradient-via-stops"), $("--tw-gradient-from-position", "0%", "<length-percentage>"), $("--tw-gradient-via-position", "50%", "<length-percentage>"), $("--tw-gradient-to-position", "100%", "<length-percentage>")]);
    function b(i, u) {
        r.functional(i, g => {
            if (g.value) {
                if (g.value.kind === "arbitrary") {
                    ...
                    default:
                        return w = W(w, g.modifier, t),
                        w === null ? void 0 : u.color(w)
                    }
                }
                {
    ...
    b("from", {
        color: i => [v(), a("--tw-sort", "--tw-gradient-from"), a("--tw-gradient-from", i), a("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position,) var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")],
        position: i => [v(), a("--tw-gradient-from-position", i)]
    }),
    e("via-none", [["--tw-gradient-via-stops", "initial"]]),
    b("via", {
        color: i => [v(), a("--tw-sort", "--tw-gradient-via"), a("--tw-gradient-via", i), a("--tw-gradient-via-stops", "var(--tw-gradient-position,) var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-via) var(--tw-gradient-via-position), var(--tw-gradient-to) var(--tw-gradient-to-position)"), a("--tw-gradient-stops", "var(--tw-gradient-via-stops)")],
        position: i => [v(), a("--tw-gradient-via-position", i)]
    }),
    b("to", {
        color: i => [v(), a("--tw-sort", "--tw-gradient-to"), a("--tw-gradient-to", i), a("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position,) var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")],
        position: i => [v(), a("--tw-gradient-to-position", i)]
    }),
    e("box-decoration-slice", [["-webkit-box-decoration-break", "slice"], ["box-decoration-break", "slice"]]),
    e("box-decoration-clone", [["-webkit-box-decoration-break", "clone"], ["box-decoration-break", "clone"]]),
    ...
    for (let i of ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"])
    ...
    r.functional("stroke", i => {
        if (i.value) {
            if (i.value.kind === "arbitrary") {
                ...
                default:
                    return u = W(i.value.value, i.modifier, t),
            ...
            }
            {
                ...
                if (u)
                    return [a("stroke-width", u)];
                if (N(i.value.value))
                    return [a("stroke-width", i.value.value)]
            }
        }
    }
    ),
    ...
    for (let[i,u] of [["p", "padding"], ["px", "padding-inline"], ["py", "padding-block"], ["ps", "padding-inline-start"], ["pe", "padding-inline-end"], ["pt", "padding-top"], ["pr", "padding-right"], ["pb", "padding-bottom"], ["pl", "padding-left"]])
    ...
    r.functional("font", i => {
        if (!(!i.value || i.modifier)) {
            ...
            }
            {
                ...
                if (u) {
                    let[g,w={}] = u;
                    return [a("font-family", g), a("font-feature-settings", w["--font-feature-settings"]), a("font-variation-settings", w["--font-variation-settings"])]
                }
            }
            {
        ...
        if (i.value) {
            ...
            }
            {
                ...
                if (u)
                    return i.modifier ? void 0 : [a("text-decoration-thickness", u)];
                if (N(i.value.value))
                    return i.modifier ? void 0 : [a("text-decoration-thickness", `${i.value.value}px`)]
            }
            {
                let u = G(i, t, ["--text-decoration-color", "--color"]);
                if (u)
                    return [a("text-decoration-color", u)]
            }
        }
    }
    ),
    ...
    });
    {
        let i = ["var(--tw-blur,)", "var(--tw-brightness,)", "var(--tw-contrast,)", "var(--tw-grayscale,)", "var(--tw-hue-rotate,)", "var(--tw-invert,)", "var(--tw-saturate,)", "var(--tw-sepia,)", "var(--tw-drop-shadow,)"].join(" ")
          , u = ["var(--tw-backdrop-blur,)", "var(--tw-backdrop-brightness,)", "var(--tw-backdrop-contrast,)", "var(--tw-backdrop-grayscale,)", "var(--tw-backdrop-hue-rotate,)", "var(--tw-backdrop-invert,)", "var(--tw-backdrop-opacity,)", "var(--tw-backdrop-saturate,)", "var(--tw-backdrop-sepia,)"].join(" ")
          , g = () => D([$("--tw-blur"), $("--tw-brightness"), $("--tw-contrast"), $("--tw-grayscale"), $("--tw-hue-rotate"), $("--tw-invert"), $("--tw-opacity"), $("--tw-saturate"), $("--tw-sepia")])
          , w = () => D([$("--tw-backdrop-blur"), $("--tw-backdrop-brightness"), $("--tw-backdrop-contrast"), $("--tw-backdrop-grayscale"), $("--tw-backdrop-hue-rotate"), $("--tw-backdrop-invert"), $("--tw-backdrop-opacity"), $("--tw-backdrop-saturate"), $("--tw-backdrop-sepia")]);
        r.functional("filter", k => {
            if (!k.modifier) {
                if (k.value === null)
                    return [g(), a("filter", i)];
                if (k.value.kind === "arbitrary")
                    return [a("filter", k.value.value)];
        ...
        r.functional("backdrop-filter", k => {
            if (!k.modifier) {
                if (k.value === null)
                    return [w(), a("-webkit-backdrop-filter", u), a("backdrop-filter", u)];
                if (k.value.kind === "arbitrary")
        ...
        n("blur", {
            themeKeys: ["--blur"],
            handle: k => [g(), a("--tw-blur", `blur(${k})`), a("filter", i)]
        }),
        e("blur-none", [g, ["--tw-blur", " "], ["filter", i]]),
        n("backdrop-blur", {
            themeKeys: ["--backdrop-blur", "--blur"],
            handle: k => [w(), a("--tw-backdrop-blur", `blur(${k})`), a("-webkit-backdrop-filter", u), a("backdrop-filter", u)]
        }),
        ...
        n("backdrop-brightness", {
            ...
            handleBareValue: ({value: k}) => N(k) ? `${k}%` : null,
            handle: k => [w(), a("--tw-backdrop-brightness", `brightness(${k})`), a("-webkit-backdrop-filter", u), a("backdrop-filter", u)]
        }),
        o("brightness", () => [{
            values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"],
        ...
        n("backdrop-contrast", {
            ...
            handleBareValue: ({value: k}) => N(k) ? `${k}%` : null,
            handle: k => [w(), a("--tw-backdrop-contrast", `contrast(${k})`), a("-webkit-backdrop-filter", u), a("backdrop-filter", u)]
        }),
        o("contrast", () => [{
        ...
        n("backdrop-grayscale", {
            ...
            handleBareValue: ({value: k}) => N(k) ? `${k}%` : null,
            defaultValue: "100%",
            handle: k => [w(), a("--tw-backdrop-grayscale", `grayscale(${k})`), a("-webkit-backdrop-filter", u), a("backdrop-filter", u)]
        }),
        o("grayscale", () => [{
        ...
        n("backdrop-hue-rotate", {
            ...
            handleBareValue: ({value: k}) => N(k) ? `${k}deg` : null,
            handle: k => [w(), a("--tw-backdrop-hue-rotate", `hue-rotate(${k})`), a("-webkit-backdrop-filter", u), a("backdrop-filter", u)]
        }),
        o("hue-rotate", () => [{
        ...
        n("backdrop-invert", {
            ...
            handleBareValue: ({value: k}) => N(k) ? `${k}%` : null,
            defaultValue: "100%",
            handle: k => [w(), a("--tw-backdrop-invert", `invert(${k})`), a("-webkit-backdrop-filter", u), a("backdrop-filter", u)]
        }),
        o("invert", () => [{
            values: ["0", "25", "50", "75", "100"],
        ...
        n("backdrop-saturate", {
            ...
            handleBareValue: ({value: k}) => N(k) ? `${k}%` : null,
            handle: k => [w(), a("--tw-backdrop-saturate", `saturate(${k})`), a("-webkit-backdrop-filter", u), a("backdrop-filter", u)]
        }),
        o("saturate", () => [{
        ...
        n("backdrop-sepia", {
            ...
            handleBareValue: ({value: k}) => N(k) ? `${k}%` : null,
            defaultValue: "100%",
            handle: k => [w(), a("--tw-backdrop-sepia", `sepia(${k})`), a("-webkit-backdrop-filter", u), a("backdrop-filter", u)]
        }),
        o("sepia", () => [{
            values: ["0", "50", "100"],
        ...
        n("drop-shadow", {
            ...
            handle: k => [g(), a("--tw-drop-shadow", K(k, ",").map(T => `drop-shadow(${T})`).join(" ")), a("filter", i)]
        }),
        n("backdrop-opacity", {
            themeKeys: ["--backdrop-opacity", "--opacity"],
            handleBareValue: ({value: k}) => Ue(k) ? `${k}%` : null,
            handle: k => [w(), a("--tw-backdrop-opacity", `opacity(${k})`), a("-webkit-backdrop-filter", u), a("backdrop-filter", u)]
        }),
        o("backdrop-opacity", () => [{
            values: Array.from({
                length: 21
    ...
    }
    {
        ...
        e("transition-all", [["transition-property", "all"], ["transition-timing-function", i], ["transition-duration", u]]),
        e("transition-colors", [["transition-property", "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to"], ["transition-timing-function", i], ["transition-duration", u]]),
        e("transition-opacity", [["transition-property", "opacity"], ["transition-timing-function", i], ["transition-duration", u]]),
        e("transition-shadow", [["transition-property", "box-shadow"], ["transition-timing-function", i], ["transition-duration", u]]),
        e("transition-transform", [["transition-property", "transform, translate, scale, rotate"], ["transition-timing-function", i], ["transition-duration", u]]),
        n("transition", {
        ...
        });
        {
            ...
            r.functional("duration", w => {
                if (w.modifier || !w.value)
                    return;
                let k = null;
                if (w.value.kind === "arbitrary" ? k = w.value.value : (k = t.resolve(w.value.fraction ?? w.value.value, ["--transition-duration"]),
    ...
    }
    {
        ...
        n("ease", {
            themeKeys: ["--ease"],
            handle: u => [i(), a("--tw-ease", u), a("transition-timing-function", u)]
        })
    }
    ...
    e("content-none", [["--tw-content", "none"], ["content", "none"]]),
    n("content", {
        themeKeys: [],
    ...
    l("leading", ["--leading", "--spacing"], i => [D([$("--tw-leading")]), a("--tw-leading", i), a("line-height", i)]),
    n("tracking", {
        supportsNegative: !0,
        themeKeys: ["--tracking"],
    ...
    e("subpixel-antialiased", [["-webkit-font-smoothing", "auto"], ["-moz-osx-font-smoothing", "auto"]]);
    {
        let i = "var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)"
          , u = () => D([$("--tw-ordinal"), $("--tw-slashed-zero"), $("--tw-numeric-figure"), $("--tw-numeric-spacing"), $("--tw-numeric-fraction")]);
    ...
    }
    {
        ...
        r.static("outline-hidden", () => [a("outline-style", "none"), P("@media", "(forced-colors: active)", [a("outline", "2px solid transparent"), a("outline-offset", "2px")])]),
        e("outline-none", [["--tw-outline-style", "none"], ["outline-style", "none"]]),
        e("outline-solid", [["--tw-outline-style", "solid"], ["outline-style", "solid"]]),
        e("outline-dashed", [["--tw-outline-style", "dashed"], ["outline-style", "dashed"]]),
        e("outline-dotted", [["--tw-outline-style", "dotted"], ["outline-style", "dotted"]]),
        e("outline-double", [["--tw-outline-style", "double"], ["outline-style", "double"]]),
        r.functional("outline", u => {
            ...
            if (u.value.kind === "arbitrary") {
                ...
                default:
                    return g = W(g, u.modifier, t),
                    g === null ? void 0 : [a("outline-color", g)]
                }
            }
            {
                let g = G(u, t, ["--outline-color", "--color"]);
                if (g)
                    return [a("outline-color", g)]
            }
            {
                if (u.modifier)
                    return;
                ...
                if (g)
                    return [i(), a("outline-style", "var(--tw-outline-style)"), a("outline-width", g)];
                if (N(u.value.value))
                ...
                case "relative-size":
                    {
                        if (i.modifier) {
                            ...
                            if (w)
                                return [a("font-size", u), a("line-height", w)]
                        }
            ...
            }
            {
                ...
                if (u) {
                    ...
                    if (i.modifier) {
                        ...
                        let T = [a("font-size", g)];
                        return k && T.push(a("line-height", k)),
                        T
                    }
                    return typeof w == "string" ? [a("font-size", g), a("line-height", w)] : [a("font-size", g), a("line-height", w["--line-height"] ? `var(--tw-leading, ${w["--line-height"]})` : void 0), a("letter-spacing", w["--letter-spacing"] ? `var(--tw-tracking, ${w["--letter-spacing"]})` : void 0), a("font-weight", w["--font-weight"] ? `var(--tw-font-weight, ${w["--font-weight"]})` : void 0)]
                }
            }
        }
    }
    ...
    }]);
    {
        ...
        let i = ["var(--tw-inset-shadow)", "var(--tw-inset-ring-shadow)", "var(--tw-ring-offset-shadow)", "var(--tw-ring-shadow)", "var(--tw-shadow)"].join(", ")
          , u = "0 0 #0000"
          , g = () => D([$("--tw-shadow", u), $("--tw-shadow-color"), $("--tw-inset-shadow", u), $("--tw-inset-shadow-color"), $("--tw-ring-color"), $("--tw-ring-shadow", u), $("--tw-inset-ring-color"), $("--tw-inset-ring-shadow", u), $("--tw-ring-inset"), $("--tw-ring-offset-width", "0px", "<length>"), $("--tw-ring-offset-color", "#fff"), $("--tw-ring-offset-shadow", u)]);
        e("shadow-initial", [g, ["--tw-shadow-color", "initial"]]),
        r.functional("shadow", C => {
            if (!C.value) {
                let A = t.get(["--shadow"]);
                return A === null ? void 0 : [g(), a("--tw-shadow", ae(A, j => `var(--tw-shadow-color, ${j})`)), a("box-shadow", i)]
            }
            if (C.value.kind === "arbitrary") {
                let A = C.value.value;
                switch (C.value.dataType ?? F(A, ["color"])) {
                case "color":
                    return A = W(A, C.modifier, t),
                    A === null ? void 0 : [g(), a("--tw-shadow-color", A)];
                default:
                    return [g(), a("--tw-shadow", ae(A, Te => `var(--tw-shadow-color, ${Te})`)), a("box-shadow", i)]
                }
            }
            ...
            }
            {
                ...
                if (A)
                    return C.modifier ? void 0 : [g(), a("--tw-shadow", ae(A, j => `var(--tw-shadow-color, ${j})`)), a("box-shadow", i)]
            }
            {
                let A = G(C, t, ["--box-shadow-color", "--color"]);
                if (A)
                    return [g(), a("--tw-shadow-color", A)]
            }
        }
        ),
        o("shadow", () => [{
        ...
        r.functional("inset-shadow", C => {
            if (!C.value) {
                ...
                return A === null ? void 0 : [g(), a("--tw-inset-shadow", ae(A, j => `var(--tw-inset-shadow-color, ${j})`)), a("box-shadow", i)]
            }
            if (C.value.kind === "arbitrary") {
                let A = C.value.value;
                switch (C.value.dataType ?? F(A, ["color"])) {
                case "color":
                    return A = W(A, C.modifier, t),
                    A === null ? void 0 : [g(), a("--tw-inset-shadow-color", A)];
                default:
                    return [g(), a("--tw-inset-shadow", `inset ${ae(A, Te => `var(--tw-inset-shadow-color, ${Te})`)}`), a("box-shadow", i)]
                }
            }
            switch (C.value.value) {
            case "none":
            ...
            }
            {
                ...
                if (A)
                    return C.modifier ? void 0 : [g(), a("--tw-inset-shadow", ae(A, j => `var(--tw-inset-shadow-color, ${j})`)), a("box-shadow", i)]
            }
            {
                let A = G(C, t, ["--box-shadow-color", "--color"]);
                if (A)
                    return [g(), a("--tw-inset-shadow-color", A)]
            }
        }
        ),
        o("inset-shadow", () => [{
        ...
        r.functional("ring", C => {
            ...
            if (C.value.kind === "arbitrary") {
                ...
                default:
                    return A = W(A, C.modifier, t),
                    A === null ? void 0 : [a("--tw-ring-color", A)]
                }
            }
            {
                let A = G(C, t, ["--ring-color", "--color"]);
                if (A)
                    return [a("--tw-ring-color", A)]
            }
            {
                if (C.modifier)
                    return;
                let A = t.resolve(C.value.value, ["--ring-width"]);
                if (A === null && N(C.value.value) && (A = `${C.value.value}px`),
                A)
                    return [g(), a("--tw-ring-shadow", k(A)), a("box-shadow", i)]
            }
        }
        ...
        r.functional("inset-ring", C => {
            if (!C.value)
                return C.modifier ? void 0 : [g(), a("--tw-inset-ring-shadow", T("1px")), a("box-shadow", i)];
            if (C.value.kind === "arbitrary") {
                let A = C.value.value;
                switch (C.value.dataType ?? F(A, ["color", "length"])) {
                case "length":
                ...
                default:
                    return A = W(A, C.modifier, t),
                    A === null ? void 0 : [a("--tw-inset-ring-color", A)]
                }
            }
            {
                let A = G(C, t, ["--ring-color", "--color"]);
                if (A)
                    return [a("--tw-inset-ring-color", A)]
            }
            {
                if (C.modifier)
                    return;
        ...
        r.functional("ring-offset", C => {
            if (C.value) {
                if (C.value.kind === "arbitrary") {
                    ...
                    default:
                        return A = W(A, C.modifier, t),
                        A === null ? void 0 : [a("--tw-ring-offset-color", A)]
                    }
                }
                {
                    ...
                    if (A)
                        return C.modifier ? void 0 : [a("--tw-ring-offset-width", A), a("--tw-ring-offset-shadow", O)];
                    if (N(C.value.value))
                        return C.modifier ? void 0 : [a("--tw-ring-offset-width", `${C.value.value}px`), a("--tw-ring-offset-shadow", O)]
                }
                {
                    let A = G(C, t, ["--ring-offset-color", "--color"]);
                    if (A)
                        return [a("--tw-ring-offset-color", A)]
                }
            }
        }
        )
    ...
    r.functional("@container", i => {
        let u = null;
        if (i.value === null ? u = "inline-size" : i.value.kind === "arbitrary" ? u = i.value.value : i.value.kind === "named" && i.value.value === "normal" && (u = "normal"),
        u !== null)
...
function Yt(t) {
    ...
    return Mo.test(r) ? o => {
        let e = new Set
          , n = new Set;
        _(t.nodes, s => {
            if (s.kind !== "declaration" || !s.value || !s.value.includes("--value(") && !s.value.includes("--modifier("))
                return;
            let l = M(s.value);
            fe(l, f => {
        ...
        o.utilities.functional(r.slice(0, -2), s => {
            ...
            let c = !1
              ...
              , y = new Map
              , v = !1;
            if (_([l], (b, {parent: x, replaceWith: S}) => {
                if (x?.kind !== "rule" && x?.kind !== "at-rule" || b.kind !== "declaration" || !b.value)
                    return;
                let V = M(b.value);
...
function Ht(t, r, o) {
    for (let e of r.nodes)
        if (t.kind === "named" && e.kind === "word" && e.value[0] === "-" && e.value[1] === "-") {
            ...
            if (e.value !== "number" && e.value !== "integer" && e.value !== "ratio" && e.value !== "percentage")
                continue;
            ...
            if ("dataType"in t && t.dataType && t.dataType !== n)
                continue;
...
function Wo(t, r, ...o) {
    ...
    if (!e || !n)
        throw new Error(`The --alpha(\u2026) function requires a color and an alpha value, e.g.: \`--alpha(${e || "var(--my-color)"} / ${n || "50%"})\``);
    if (o.length > 0)
        throw new Error(`The --alpha(\u2026) function only accepts one argument, e.g.: \`--alpha(${e || "var(--my-color)"} / ${n || "50%"})\``);
    return J(e, n)
}
function Bo(t, r, ...o) {
    if (!r)
...
var Jt = new RegExp(Object.keys(ut).map(t => `${t}\\(`).join("|"));
function pe(t, r) {
    let o = 0;
    return _(t, e => {
        if (e.kind === "declaration" && e.value && Jt.test(e.value)) {
            o |= 8,
            e.value = Zt(e.value, r);
            return
        }
        e.kind === "at-rule" && (e.name === "@media" || e.name === "@custom-media" || e.name === "@container" || e.name === "@supports") && Jt.test(e.params) && (o |= 8,
        e.params = Zt(e.params, r))
    }
    ),
    o
}
    ...
    for (let o of t.utilities.keys("functional")) {
        ...
        for (let n of e)
            for (let s of n.values) {
                ...
                n.supportsNegative && r.push([`-${l}`, {
                    modifiers: n.modifiers
                }])
            }
    }
    return r.sort( (o, e) => o[0] === e[0] ? 0 : o[0] < e[0] ? -1 : 1),
    r
}
function er(t) {
    let r = [];
    for (let[e,n] of t.variants.entries()) {
        let l = function({value: f, modifier: d}={}) {
            ...
            if (me(m, p, t.variants) === null)
                return [];
            let h = [];
            return ze(m.nodes, (y, {path: v}) => {
                if (y.kind !== "rule" && y.kind !== "at-rule" || y.nodes.length > 0)
                    return;
                v.sort( (S, V) => {
                ...
                let b = v.flatMap(S => S.kind === "rule" ? S.selector === "&" ? [] : [S.selector] : S.kind === "at-rule" ? [`${S.name} ${S.params}`] : [])
                  , x = "";
...
var ft = class {
    ...
    compoundsWith(r, o) {
        ...
        return !(!e || !n || e.kind !== "compound" || n.compounds === 0 || e.compoundsWith === 0 || !(e.compoundsWith & n.compounds))
    }
    suggest(r, o) {
        this.completions.set(r, o)
    }
    ...
    set(r, {kind: o, applyFn: e, compounds: n, compoundsWith: s, order: l}) {
        ...
        f ? Object.assign(f, {
            ...
            applyFn: e,
            compounds: n
        }) : (l === void 0 && (this.lastOrder = this.nextOrder(),
        l = this.lastOrder),
        this.variants.set(r, {
            kind: o,
            applyFn: e,
...
function or(t) {
    ...
    function s(c) {
        for (let p of n) {
            if (p !== c.name)
                continue;
            let m = K(c.params, ",");
            return m.length > 1 ? null : (m = e(c.name, m),
            P(c.name, m.join(", ")))
        }
        return null
    }
    function l(c) {
        return c.includes("::") ? null : `&:not(${K(c, ",").map(m => (m.startsWith("&:is(") && m.endsWith(")") && (m = m.slice(5, -1)),
        m = m.replaceAll("&", "*"),
        m)).join(", ")})`
    }
    r.compound("not", 3, (c, p) => {
        ...
        if (_([c], (h, {path: y}) => {
            ...
            let v = []
              , b = [];
            for (let S of y)
                S.kind === "at-rule" ? v.push(S) : S.kind === "rule" && b.push(S);
            if (v.length > 1)
                return 2;
            if (b.length > 1)
                return 2;
    ...
    {
        let c = function() {
            return D([P("@property", "--tw-content", [a("syntax", '"*"'), a("initial-value", '""'), a("inherits", "false")])])
        };
        var f = c;
        r.static("before", p => {
    ...
    r.functional("aria", (c, p) => {
        if (!p.value || p.modifier)
            return null;
        p.value.kind === "arbitrary" ? c.nodes = [U(`&[aria-${rr(p.value.value)}]`, c.nodes)] : c.nodes = [U(`&[aria-${p.value.value}="true"]`, c.nodes)]
    }
    ),
    r.suggest("aria", () => ["busy", "checked", "disabled", "expanded", "hidden", "pressed", "readonly", "required", "selected"]),
    ...
    r.functional("nth", (c, p) => {
        if (!p.value || p.modifier || p.value.kind === "named" && !N(p.value.value))
            return null;
        ...
        var d = c;
        {
            let p = t.namespace("--breakpoint")
              , m = new I(h => {
                ...
                case "functional":
                    {
                        if (!h.value || h.modifier)
                            return null;
                        let y = null;
                        return h.value.kind === "arbitrary" ? y = h.value.value : h.value.kind === "named" && (y = t.resolveValue(h.value.value, ["--breakpoint"])),
        ...
        }
        {
                ...
                case "functional":
                    {
                        if (h.value === null)
                            return null;
                        let y = null;
                        return h.value.kind === "arbitrary" ? y = h.value.value : h.value.kind === "named" && (y = t.resolveValue(h.value.value, ["--container"])),
                        !y || y.includes("var(") ? null : y
                    }
                case "static":
                case "arbitrary":
            ...
            r.group( () => {
                r.functional("@max", (h, y) => {
                    ...
                    if (v === null)
                        return null;
                    h.nodes = [P("@container", y.modifier ? `${y.modifier.value} (width < ${v})` : `(width < ${v})`, h.nodes)]
                }
                , {
                    compounds: 1
                })
    ...
    return o("portrait", ["@media (orientation: portrait)"]),
...
function dt(t, r) {
    _(t, (o, {replaceWith: e}) => {
        if (o.kind === "at-rule" && o.name === "@slot")
            ...
            return Object.assign(o, D([P(o.name, o.params, o.nodes)])),
            1
    }
    )
}
      ...
      , l = {
        ...
        candidatesToCss(f) {
            ...
            for (let c of f) {
                ...
                m = ie(m),
                m.length === 0 || p ? d.push(null) : d.push(Y(m))
            }
            return d
        },
        getClassOrder(f) {
        ...
        getVariantOrder() {
            ...
            let d = new Map, c, p = 0;
            for (let m of f)
                m !== null && (c !== void 0 && this.variants.compare(c, m) !== 0 && p++,
                d.set(m, p),
                c = m);
            return d
        },
        ...
        if (l !== f) {
            if (l >= 48 && l <= 57 && f >= 48 && f <= 57) {
                let d = s
                  ...
                  , p = s
                  , m = s + 1;
                for (l = t.charCodeAt(c); l >= 48 && l <= 57; )
                    l = t.charCodeAt(++c);
                for (f = r.charCodeAt(m); f >= 48 && f <= 57; )
                    f = r.charCodeAt(++m);
                let h = t.slice(d, c)
                  , y = r.slice(p, m);
...
function ge(t) {
    ...
    var r = String(t), o = r.length, e = -1, n, s = "", l = r.charCodeAt(0);
    if (o == 1 && l == 45)
        return "\\" + r;
    for (; ++e < o; ) {
        if (n = r.charCodeAt(e),
...
function te(t, r, {onInvalidCandidate: o}={}) {
    ...
    return n.sort( (f, d) => {
        ...
        let m = 0;
        for (; c.properties.length < m && p.properties.length < m && c.properties[m] === p.properties[m]; )
            m += 1;
        return (c.properties[m] ?? 1 / 0) - (p.properties[m] ?? 1 / 0) || p.properties.length - c.properties.length || lr(c.candidate, p.candidate)
    }
    ),
    {
        astNodes: n,
...
function ir(t, r) {
    ...
    for (let s of o) {
        ...
        for (let d of t.variants)
            if (me(f, d, r.variants) === null)
                return [];
        e.push({
            node: f,
            propertySort: l
...
function me(t, r, o, e=0) {
    ...
    if (r.kind === "compound") {
        let l = P("@slot");
        if (me(l, r.variant, o, e + 1) === null || r.root === "not" && l.nodes.length > 1)
            return null;
        for (let d of l.nodes)
            if (d.kind !== "rule" && d.kind !== "at-rule" || n(d, r) === null)
                return null;
        _(l.nodes, d => {
            if ((d.kind === "rule" || d.kind === "at-rule") && d.nodes.length <= 0)
                return d.nodes = t.nodes,
                1
        }
        ),
        t.nodes = l.nodes;
...
function Go(t, r) {
    if (t.kind === "arbitrary") {
        let l = t.value;
        return t.modifier && (l = W(l, t.modifier, r.theme)),
...
function ur(t) {
    for (let r of t)
        r.kind !== "at-root" && (r.kind === "declaration" ? r.important = !0 : (r.kind === "rule" || r.kind === "at-rule") && ur(r.nodes))
}
function Yo(t) {
    let r = new Set
      , o = t.slice();
    ...
    function p(m, h=[]) {
        if (!f.has(m)) {
            if (c.has(m)) {
                ...
                throw m.kind === "at-rule" && m.name === "@utility" && y.kind === "at-rule" && y.name === "@utility" && _(m.nodes, v => {
                    if (v.kind !== "at-rule" || v.name !== "@apply")
                        return;
                        ...
                        for (let S of r.parseCandidate(x))
                            ...
                            case "functional":
                                if (y.params.replace(/-\*$/, "") === S.root)
                                    throw new Error(`You cannot \`@apply\` the \`${x}\` utility here because it creates a circular dependency.`);
                                break;
                            default:
                            }
                }
...
async function mt(t, r, o, e=0) {
    let n = 0
      , s = [];
    return _(t, (l, {replaceWith: f}) => {
        if (l.kind === "at-rule" && (l.name === "@import" || l.name === "@reference")) {
            let d = Jo(M(l.params));
            if (d === null)
                return;
            l.name === "@reference" && (d.media = "reference"),
            n |= 2;
            ...
            return s.push((async () => {
                if (e > 100)
                    throw new Error(`Exceeded maximum recursion depth while resolving \`${c}\` in \`${r}\`)`);
                let v = await o(c, r)
                  , b = ce(v.content);
                await mt(b, v.base, o, e + 1),
                y.nodes = Zo([ne({
                    base: v.base
                }, b)], p, m, h)
            }
...
function Zo(t, r, o, e) {
    let n = t;
    return r !== null && (n = [P("@layer", r, n)]),
    o !== null && (n = [P("@media", o, n)]),
    e !== null && (n = [P("@supports", e[0] === "(" ? e : `(${e})`, n)]),
    n
}
var dr = new Map([["--font", ["--font-weight", "--font-size"]], ["--inset", ["--inset-shadow", "--inset-ring"]], ["--text", ["--text-color", "--text-underline-offset", "--text-indent", "--text-decoration-thickness", "--text-decoration-color"]]]);
function fr(t, r) {
...
var Fe = class {
    ...
    entries() {
        return this.prefix ? Array.from(this.values, r => (r[0] = this.#r(r[0]),
        r)) : this.values.entries()
    }
    #r(r) {
    ...
    namespace(r) {
        ...
        for (let[n,s] of this.values)
            n === r ? o.set(null, s.value) : n.startsWith(`${e}-`) ? o.set(n.slice(r.length), s.value) : n.startsWith(e) && o.set(n.slice(e.length), s.value);
        return o
    }
    addKeyframes(r) {
...
function mr(t, {theme: r}, o) {
    ...
    for (let[e,n] of Qo(r)) {
        if (typeof n != "string" && typeof n != "number")
            continue;
        if (typeof n == "string" && (n = n.replace(/<alpha-value>/g, "1")),
    ...
    if (Object.hasOwn(r, "fontFamily")) {
        let e = 5;
        {
            ...
            n && t.theme.hasDefault("--font-sans") && (t.theme.add("--default-font-family", n, e),
            t.theme.add("--default-font-feature-settings", he(r.fontFamily.sans, "fontFeatureSettings") ?? "normal", e),
            t.theme.add("--default-font-variation-settings", he(r.fontFamily.sans, "fontVariationSettings") ?? "normal", e))
        }
        {
            let n = he(r.fontFamily.mono);
            n && t.theme.hasDefault("--font-mono") && (t.theme.add("--default-mono-font-family", n, e),
            t.theme.add("--default-mono-font-feature-settings", he(r.fontFamily.mono, "fontFeatureSettings") ?? "normal", e),
            t.theme.add("--default-mono-font-variation-settings", he(r.fontFamily.mono, "fontVariationSettings") ?? "normal", e))
        }
    }
    return r
}
...
function tn(t) {
    if (!Array.isArray(t) || t.length !== 2 || typeof t[0] != "string" && typeof t[0] != "number" || t[1] === void 0 || t[1] === null || typeof t[1] != "object")
        return !1;
...
function gr(t, r=[], o) {
    for (let e of Reflect.ownKeys(t)) {
        ...
        if (l !== 1) {
            if (l === 2)
                return 2;
            if (!(!Array.isArray(n) && typeof n != "object") && gr(n, s, o) === 2)
                return 2
        }
    }
}
function Le(t) {
    ...
    for (let o of K(t, ".")) {
        ...
        for (; ; ) {
            ...
            if (n === -1 || s === -1)
                break;
            n > e && r.push(o.slice(e, n)),
            r.push(o.slice(n + 1, s)),
            e = s + 1
        }
...
function Me(t, r, o) {
    return function(n, s) {
        let l = n.lastIndexOf("/")
          , f = null;
        l !== -1 && (f = n.slice(l + 1).trim(),
        n = n.slice(0, l).trim());
        let d = ( () => {
            let c = Le(n)
              , [p,m] = rn(t.theme, c)
              , h = o(hr(r() ?? {}, c) ?? null);
            if (typeof h == "string" && (h = h.replace("<alpha-value>", "1")),
            typeof p != "object")
            ...
            if (h !== null && typeof h == "object" && !Array.isArray(h)) {
                ...
                if (p === null && Object.hasOwn(h, "__CSS_VALUES__")) {
                    let v = {};
                    for (let b in h.__CSS_VALUES__)
                        v[b] = h[b],
                        delete y[b];
                    p = v
                }
                for (let v in p)
                    v !== "__CSS_VALUES__" && (h?.__CSS_VALUES__?.[v] & 4 && hr(y, v.split("-")) !== void 0 || (y[ar(v)] = p[v]));
                return y
            }
            if (Array.isArray(p) && Array.isArray(m) && Array.isArray(h)) {
                let y = p[0]
                  , v = p[1];
                m[0] & 4 && (y = h[0] ?? y);
                for (let b of Object.keys(v))
                    m[1][b] & 4 && (v[b] = h[1][b] ?? v[b]);
                return [y, v]
            }
            return p ?? h
        }
        )();
        return f && typeof d == "string" && (d = J(d, f)),
        d ?? s
    }
}
function rn(t, r) {
    ...
    for (let[p,m] of l)
        br(c, [p ?? "DEFAULT"], m);
    return r[r.length - 1] === "DEFAULT" ? [d?.DEFAULT ?? null, c.DEFAULT ?? 0] : "DEFAULT"in d && Object.keys(d).length === 1 ? [d.DEFAULT, c.DEFAULT ?? 0] : (d.__CSS_VALUES__ = c,
    [d, c])
}
function hr(t, r) {
...
function We(t, r, o=null) {
    for (let e = 0; e < t.length; e++) {
        ...
        if (s === 2)
            return 2;
        if (s !== 1 && n.kind === "function" && We(n.nodes, r, n) === 2)
            return 2
    }
}
function Be(t) {
        ...
        case Tr:
            {
                if (n.length > 0) {
                    let h = Ne(n);
                    e ? e.nodes.push(h) : r.push(h),
                    n = ""
                }
                let d = l
                  , c = l + 1;
                for (; c < t.length && (s = t.charCodeAt(c),
                !(s !== kr && s !== wr && s !== xr && s !== Nr && s !== $r && s !== Sr && s !== Tr)); c++)
                    ;
                l = c - 1;
                let p = t.slice(d, c)
                  , m = p.trim() === "," ? ln(p) : on(p);
        ...
        case Cr:
            {
                let d = nn(n, []);
                if (n = "",
                d.value !== ":not" && d.value !== ":where" && d.value !== ":has" && d.value !== ":is") {
                    let c = l + 1
                      , p = 0;
        ...
        case yr:
            {
                ...
                n += String.fromCharCode(f) + String.fromCharCode(d),
                l += 1;
                break
            }
        default:
...
function ht({designSystem: t, ast: r, resolvedConfig: o, featuresRef: e, referenceMode: n}) {
    let s = {
        addBase(l) {
            ...
            let f = Q(l);
            e.current |= pe(f, t),
            r.push(P("@layer", "base", f))
        },
        addVariant(l, f) {
            if (!je.test(l))
                throw new Error(`\`addVariant('${l}')\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
        ...
        matchVariant(l, f, d) {
            ...
            , (m, h) => {
                if (m.kind !== "functional" || h.kind !== "functional")
                    return 0;
        ...
        addUtilities(l) {
            ...
            for (let[c,p] of f) {
                ...
                if (We(m, y => {
                    ...
                    if (y.kind === "function" && y.value === ":not")
                        return 1
                }
                ),
                !h)
        ...
        matchUtilities(l, f) {
            ...
            for (let[p,m] of Object.entries(l)) {
                let h = function({negative: y}) {
                    return v => {
                        if (v.value?.kind === "arbitrary" && d.length > 0 && !d.includes("any") && (v.value.dataType && !d.includes(v.value.dataType) || !v.value.dataType && !F(v.value.value, d)))
                            return;
                          ...
                          , S = !1;
                        {
                            ...
                            v.value ? v.value.kind === "arbitrary" ? x = v.value.value : v.value.fraction && E[v.value.fraction] ? (x = E[v.value.fraction],
                            S = !0) : E[v.value.value] ? x = E[v.value.value] : E.__BARE_VALUE__ && (x = E.__BARE_VALUE__(v.value) ?? null,
                            S = (v.value.fraction !== null && x?.includes("/")) ?? !1) : x = E.DEFAULT ?? null
                        }
                        if (x === null)
                            return;
                        let V;
                        {
                            ...
                            v.modifier ? E === "any" || v.modifier.kind === "arbitrary" ? V = v.modifier.value : E?.[v.modifier.value] ? V = E[v.modifier.value] : b && !Number.isNaN(Number(v.modifier.value)) ? V = `${v.modifier.value}%` : V = null : V = null
                        }
                        if (v.modifier && V === null && !S)
                        ...
                        return e.current |= Ce(R, t),
                        R
                    }
                };
                var c = h;
                if (!Vr.test(p))
                    throw new Error(`\`matchUtilities({ '${p}' : \u2026 })\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter, eg. \`scrollbar\`.`);
                ...
                t.utilities.suggest(p, () => {
                    ...
                    v.has("DEFAULT") && (v.delete("DEFAULT"),
                    v.add(null));
                    let b = f?.modifiers ?? {}
    ...
    return s.addComponents = s.addComponents.bind(s),
...
function Q(t) {
    ...
    for (let[e,n] of o)
        if (typeof n != "object")
            !e.startsWith("--") && n === "@slot" ? r.push(L(e, [P("@slot")])) : (e = e.replace(/([A-Z])/g, "-$1").toLowerCase(),
            r.push(a(e, String(n))));
        else if (Array.isArray(n))
            for (let s of n)
                typeof s == "string" ? r.push(a(e, s)) : r.push(L(e, Q(s)));
        else
            n !== null && r.push(L(e, Q(n)));
    return r
}
function Er(t, r) {
...
function yn(t, r) {
    if (Array.isArray(t) && be(t[0]))
        return t.concat(r);
    if (Array.isArray(r) && be(r[0]) && be(t))
        return [t, ...r];
    if (Array.isArray(r))
        return r
}
function bt(t, {config: r, base: o, path: e, reference: n}) {
    ...
    for (let d of r.plugins ?? [])
        "__isOptionsFunction"in d ? s.push({
            ...d(),
            reference: n
        }) : "handler"in d ? s.push({
            ...d,
    ...
    for (let d of f)
        t.content.files.push(typeof d == "object" ? d : {
            base: o,
            pattern: d
        });
    t.configs.push(r)
...
function kn({center: t, padding: r, screens: o}, e) {
    let n = []
      , s = null;
    if (t && n.push(a("margin-inline", "auto")),
    (typeof r == "string" || typeof r == "object" && r !== null && "DEFAULT"in r) && n.push(a("padding-inline", typeof r == "string" ? r : r.DEFAULT)),
    typeof o == "object" && o !== null) {
        s = new Map;
        let l = Array.from(e.theme.namespace("--breakpoint").entries());
        if (l.sort( (f, d) => le(f[1], d[1], "asc")),
        l.length > 0) {
            let[f] = l[0];
    ...
    if (typeof r == "object" && r !== null) {
        let l = Object.entries(r).filter( ([f]) => f !== "DEFAULT").map( ([f,d]) => [f, e.theme.resolveValue(f, ["--breakpoint"]), d]).filter(Boolean);
        l.sort( (f, d) => le(f[1], d[1], "asc"));
        for (let[f,,d] of l)
            if (s && s.has(f))
                s.get(f).nodes.push(a("padding-inline", d));
            else {
                if (s)
                    continue;
...
function Dr({addVariant: t, config: r}) {
    ...
    if (e === "variant") {
        let s;
        if (Array.isArray(n) || typeof n == "function" ? s = n : typeof n == "string" && (s = [n]),
        Array.isArray(s))
            for (let l of s)
                l === ".dark" ? (e = !1,
                console.warn('When using `variant` for `darkMode`, you must provide a selector.\nExample: `darkMode: ["variant", ".your-selector &"]`')) : l.includes("&") || (e = !1,
...
function Ur(t) {
    ...
    t.utilities.functional("max-w-screen", r => {
        ...
        if (o)
            return [a("max-width", o)]
    }
    ),
    t.utilities.static("overflow-ellipsis", () => [a("text-overflow", "ellipsis")]),
    t.utilities.static("decoration-slice", () => [a("-webkit-box-decoration-break", "slice"), a("box-decoration-break", "slice")]),
    t.utilities.static("decoration-clone", () => [a("-webkit-box-decoration-break", "clone"), a("box-decoration-break", "clone")]),
    t.utilities.functional("flex-shrink", r => {
        if (!r.modifier) {
            if (!r.value)
                return [a("flex-shrink", "1")];
...
function jr(t, r) {
    ...
    for (let[l,f] of Object.entries(o)) {
        ...
        if (d && c && !r.theme.hasDefault(`--breakpoint-${l}`))
            continue;
        let p = !0;
        typeof f == "string" && (p = !1);
        let m = wn(f);
    ...
    if (n.length !== 0) {
        for (let[,l] of r.variants.variants)
            l.order > e && (l.order += n.length);
        r.variants.compareFns = new Map(Array.from(r.variants.compareFns).map( ([l,f]) => (l > e && (l += n.length),
        [l, f])));
...
function Fr(t, r) {
    ...
    if (Object.keys(o).length > 0) {
        ...
        r.variants.functional("aria", (d, c) => {
            let p = c.value;
            return p && p.kind === "named" && p.value in o ? l?.(d, {
                ...c,
                value: {
                    kind: "arbitrary",
                    value: o[p.value]
                      ...
                      , R = K(V, ",").map(E => {
                        ...
                        if (Number.isNaN(Number(E))) {
                            if (E[0] === '"' && E[E.length - 1] === '"' || E[0] === "'" && E[E.length - 1] === "'")
                                return E.slice(1, -1);
                            if (E[0] === "{" && E[E.length - 1] === "}")
                                throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${Y([S]).trim()}\` is not supported.
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`)
    ...
    !l.length && !f.length)
        return 0;
    let[c,p] = await Promise.all([Promise.all(f.map(async ({id: m, base: h, reference: y}) => {
    ...
    )), Promise.all(l.map(async ([{id: m, base: h, reference: y},v]) => {
...
function Ir({designSystem: t, base: r, ast: o, globs: e, configs: n, pluginDetails: s}) {
    ...
    for (let {handler: b, reference: x} of c.plugins)
        x ? (v ||= ht({
            ...h,
            referenceMode: !0
        }),
    ...
    !t.theme.prefix && c.prefix) {
        if (c.prefix.endsWith("-") && (c.prefix = c.prefix.slice(0, -1),
        console.warn(`The prefix "${c.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only and is written as a variant before all utilities. We have fixed up the prefix for you. Remove the trailing \`-\` to silence this warning.`)),
        !xn.test(c.prefix))
            throw new Error(`The prefix "${c.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
        t.theme.prefix = c.prefix
    }
    if (!t.important && c.important === !0 && (t.important = !0),
    typeof c.important == "string") {
        let b = c.important;
        _(o, (x, {replaceWith: S, parent: V}) => {
            if (x.kind === "at-rule" && !(x.name !== "@tailwind" || x.params !== "utilities"))
                return V?.kind === "rule" && V.selector === b ? 2 : (S(U(b, [x])),
                2)
        }
        )
    }
    for (let b of c.blocklist)
        t.invalidCandidates.add(b);
...
function Nn(t) {
    let r = 0
      , o = null;
    for (let e of K(t, " "))
        e === "reference" ? r |= 2 : e === "inline" ? r |= 1 : e === "default" ? r |= 4 : e.startsWith("prefix(") && e.endsWith(")") && (o = e.slice(7, -1));
    return [r, o]
}
    ...
    _(t, (b, {parent: x, replaceWith: S, context: V}) => {
        if (b.kind === "at-rule") {
            if (b.name === "@tailwind" && (b.params === "utilities" || b.params.startsWith("utilities"))) {
                ...
                for (let E of R)
                    if (E.startsWith("source(")) {
                        ...
                        if (z[0] === '"' && z[z.length - 1] !== '"' || z[0] === "'" && z[z.length - 1] !== "'" || z[0] !== "'" && z[0] !== '"')
            ...
            if (b.name === "@source") {
                ...
                let R = b.params;
                if (R[0] === '"' && R[R.length - 1] !== '"' || R[0] === "'" && R[R.length - 1] !== "'" || R[0] !== "'" && R[0] !== '"')
                    throw new Error("`@source` paths must be quoted.");
                h.push({
                    base: V.base,
                    pattern: R.slice(1, -1)
            ...
            if (b.name === "@variant" && (x === null ? b.nodes.length === 0 ? b.name = "@custom-variant" : _(b.nodes, R => {
                if (R.kind === "at-rule" && R.name === "@slot")
                    return b.name = "@custom-variant",
                    2
            }
            ) : m.push(b)),
            b.name === "@custom-variant") {
                ...
                let[R,E] = K(b.params, " ");
                if (!je.test(R))
                    throw new Error(`\`@custom-variant ${R}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
                if (b.nodes.length > 0 && E)
                    throw new Error(`\`@custom-variant ${R}\` cannot have both a selector and a body.`);
                if (b.nodes.length === 0) {
                    if (!E)
                        throw new Error(`\`@custom-variant ${R}\` has no selector or body.`);
                    let z = K(E.slice(1, -1), ",")
                      , i = []
                      , u = [];
                    for (let g of z)
                        g = g.trim(),
                        g[0] === "@" ? i.push(g) : u.push(g);
                    f.push(g => {
                        g.variants.static(R, w => {
                            let k = [];
            ...
            if (b.name === "@media") {
                ...
                for (let z of R)
                    if (z.startsWith("source(")) {
                        ...
                        let i = z.slice(7, -1);
                        _(b.nodes, u => {
                            if (u.kind === "at-rule" && u.name === "@theme")
                                return u.params += ` prefix(${i})`,
                                1
                        }
                        )
                    } else
                        z === "important" ? s = !0 : z === "reference" ? b.nodes = [ne({
                            reference: !0
                        }, b.nodes)] : E.push(z);
                return E.length > 0 ? b.params = E.join(" ") : R.length > 0 && S(b.nodes),
                1
            }
            if (b.name === "@theme") {
                let[R,E] = Nn(b.params);
                ...
                return _(b.nodes, (z, {replaceWith: i}) => {
                    if (z.kind === "at-rule" && z.name === "@keyframes")
                        return l.addKeyframes(z),
                        i([]),
                        1;
                    if (z.kind === "comment")
                        return;
                    ...
                    let u = Y([P(b.name, b.params, [z])]).split(`
...
${u}`)
    ...
    if (c) {
        let b = [];
        for (let[S,V] of l.entries())
            V.options & 2 || b.push(a(S, V.value));
    ...
    return {
        ...
        build(h) {
            ...
            let y = !1
              , v = c.size;
            for (let x of h)
                o.invalidCandidates.has(x) || (c.add(x),
                y ||= c.size !== v);
            if (!y)
                return p ??= ie(e),
                p;
...
var Wr = `@layer theme, base, components, utilities;
...
var Yr = "text/tailwindcss", Ye, kt = new Set, vt = "", wt = document.createElement("style"), Gr = Promise.resolve(), Pn = 1, B = new Ge;
async function _n() {
    B.start("Create compiler"),
    B.start("Reading Stylesheets");
    ...
    for (let o of t)
        ...
        r += o.textContent + `
`;
    if (r.includes("@import") || (r = `@import "tailwindcss";${r}`),
    B.end("Reading Stylesheets", {
        size: r.length,
        changed: vt !== r
    }),
    vt !== r) {
...
async function Dn(t, r) {
    ...
    try {
        ...
        throw B.hit("Failed to load stylesheet", {
            id: t,
            base: r,
            error: e.message ?? e
        }),
...
async function jn(t) {
    ...
    for (let o of document.querySelectorAll("[class]"))
        for (let e of o.classList)
            kt.has(e) || (kt.add(e),
            r.add(e));
    B.end("Collect classes", {
        count: r.size
    }),
    !(r.size === 0 && t === "incremental") && (B.start("Build utilities"),
    wt.textContent = Ye.build(Array.from(r)),
...
var Fn = new MutationObserver( () => Je("full"));
function Jr(t) {
    Fn.observe(t, {
        attributes: !0,
...
new MutationObserver(t => {
    ...
    for (let e of t) {
        for (let n of e.addedNodes)
            n.nodeType === Node.ELEMENT_NODE && n.tagName === "STYLE" && n.getAttribute("type") === Yr && (Jr(n),
            r++);
        for (let n of e.addedNodes)
            n.nodeType === 1 && n !== wt && o++;
        e.type === "attributes" && o++
